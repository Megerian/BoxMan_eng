...
public class myFindView extends Activity {
    ...
    private void getLevel_inf() {
        ...
        try {
            ...
            finish();
            MyToast.showToast(this, getString(R.string.incomplete_puzzle_data), Toast.LENGTH_SHORT);
        } catch (Exception e) {
            finish();
            MyToast.showToast(this, getString(R.string.incomplete_puzzle_data), Toast.LENGTH_SHORT);
        }
            ...
            case R.id.find_solution:  //答案
                if (!m_Level && myMaps.curMap.Solved) {  //相似关卡，且有答案
                    ...
                    if (myMaps.curMap.Solved)
                        MyToast.showToast(this, getString(R.string.please_switch_to_similar_puzzles_first), Toast.LENGTH_SHORT);
                    else
                        MyToast.showToast(this, getString(R.string.there_are_no_solutions_for_similar_puzzles), Toast.LENGTH_SHORT);
                }
                return true;
