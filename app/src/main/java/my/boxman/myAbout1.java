...
public class myAbout1 extends Activity {
	...
	private TextWatcher watcher = new TextWatcher(){
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
		...
		getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
		 ...
		 builder.setMessage(getString(R.string.do_you_want_to_save_the_changes)).setCancelable(false)
		 ...
		 .setPositiveButton(R.string.yes, new DialogInterface.OnClickListener(){
			 ...
			 public void onClick(DialogInterface dialog, int which) {
		    	...
		    	if (str.length() > 0 && mySQLite.m_SQL.find_Set(str, myMaps.m_Set_id) > 0) {
		    		...
		    		builder2.setMessage(getString(R.string.duplicate_puzzle_set_title) + " \n【" + str + "】").setPositiveButton(getString(R.string.okay), null).setCancelable(false).show();
		    	} else {
					myMaps.J_Title = str;
	...
	protected void onResume() {
		super.onResume();
		tv_Count.setText(getString(R.string.puzzle_progress) + mMessage);
	}
