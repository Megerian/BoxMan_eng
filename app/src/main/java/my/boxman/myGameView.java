...
import my.boxman.deadlockDetection.DiagonalLock;
import my.boxman.deadlockDetection.FreezeLock;
import my.boxman.utilities.IntStack;
...
public class myGameView extends Activity {
            ...
            if (myClearance()) {
                if (m_bMoved) {
                    if (myMaps.curMap.Level_id > 0) {
                        ...
                        MyToast.showToast(this, getString(R.string.solved), Toast.LENGTH_SHORT);
                        saveAns(0);  //试推时，答案视作状态保存
                    }
                } else MyToast.showToast(this, getString(R.string.solved), Toast.LENGTH_SHORT);
            } else if (myMeet()) {  //正逆相合
                if (m_bMoved) {
                    zhengniHE();  //合并正逆合答案并保存
                    saveAns2();
                    if (myMaps.curMap.Level_id < 0)
                        MyToast.showToast(this, getString(R.string.forward_and_reverse_join), Toast.LENGTH_SHORT);
                } else MyToast.showToast(this, getString(R.string.forward_and_reverse_join), Toast.LENGTH_SHORT);
            }
            m_bBusing = false;
            m_bYanshi = false;
            m_bYanshi2 = false;
    ...
    private void UpData2(int i) {
        if ((i != 1 || m_nStep <= 0 || m_lstMovUnDo.isEmpty()) && mMap.d_Moves >= mMap.m_PicWidth) {
            if (myClearance())
                MyToast.showToast(this, getString(R.string.puzzle_solved_in_forward_play), Toast.LENGTH_SHORT);
            else if (myMeet())  //正逆相合
                MyToast.showToast(this, getString(R.string.puzzle_solved_by_union_of_forward_and_reverse), Toast.LENGTH_SHORT);
            m_bBusing = false;
            m_bYanshi2 = false;
            return;
        }
        ...
        if ((i != 1 || m_nStep <= 0 || m_lstMovReDo2.isEmpty()) && mMap.d_Moves >= mMap.m_PicWidth) {
            if (myClearance2()) {  //逆推通关
                if (m_bMoved) {
                    ...
                    saveAns2();
                    if (myMaps.curMap.Level_id < 0)
                        MyToast.showToast(this, getString(R.string.reverse_play), Toast.LENGTH_SHORT);
                } else MyToast.showToast(this, getString(R.string.reverse_play), Toast.LENGTH_SHORT);
            } else if (myMeet()) {  //正逆相合
                if (m_bMoved) {
                    zhengniHE();  //合并正逆合答案并保存
                    saveAns2();
                    if (myMaps.curMap.Level_id < 0)
                        MyToast.showToast(this, getString(R.string.combining_forward_and_backward), Toast.LENGTH_SHORT);
                } else MyToast.showToast(this, getString(R.string.combining_forward_and_backward), Toast.LENGTH_SHORT);
            }
            m_bBusing = false;
            return;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_sSleep = new String[] { getString(R.string.fastest), getString(R.string.faster), getString(R.string.medium), getString(R.string.slower), getString(R.string.slowest)}; //移动速度
        ...
        dlg.setTitle(getString(R.string.congratulations_)).setMessage(R.string.automatically_open_next_unsolved_puzzle)
                .setCancelable(false).setNegativeButton(R.string.no, null)
                .setPositiveButton(R.string.yes, new OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        if (k < len) {
                            ...
                            bt_TR.setText(myMaps.m_nTrun + " "+getString(R.string.transformations));
                            initMap();
                            ls_bk_cArray = bk_cArray;
                        } else {
                            MyToast.showToast(myGameView.this, getString(R.string.there_are_no_more_unsolved_puzzles), Toast.LENGTH_SHORT);
                        }
                    }
                });
        ...
        dlg0.setTitle(getString(R.string.title_exit)).setMessage(getString(R.string.there_are_unsaved_changes_Do_you_want_to_quit_anyway)).setCancelable(false).setNegativeButton(R.string.no, null)
                .setPositiveButton(R.string.yes, new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
                        myStop();
        ...
        dlg1.setTitle(getString(R.string.title_switch_puzzle)).setMessage(R.string.there_are_unsaved_changes_are_you_sure_to_switch).setCancelable(false).setNegativeButton(R.string.no, null)
                .setPositiveButton(R.string.yes, new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
        ...
        dlg2.setTitle(getString(R.string.title_switch_puzzle)).setMessage(getString(R.string.there_are_unsaved_changes_are_you_sure_to_switch)).setCancelable(false).setNegativeButton(R.string.no, null)
                .setPositiveButton(R.string.yes, new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
        ...
        dlg4.setTitle(getString(R.string.deadlock_move)).setMessage(R.string.this_move_creates_a_deadlock_do_you_want_to_continue)
                .setCancelable(false).setNegativeButton(R.string.button_continue, null)
                .setPositiveButton(R.string.undo_move, new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
        ...
        bt_UnDo.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if (bt_BK.isChecked()) {  //逆推
                    MyToast.showToast(myGameView.this, getString(R.string.restart), Toast.LENGTH_SHORT);
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    if (m_nRow2 < 0 || m_nCol2 < 0) {  //首次进入逆推模式，需要确定仓管员位置
                        mMap.m_iR = m_nRow2;
                        mMap.m_iC = m_nCol2;
                        MyToast.showToast(myGameView.this, getString(R.string.you_need_to_provide_the_player_position), Toast.LENGTH_SHORT);
                    }
                } else {
                    buttonView.setBackgroundColor(0xff778899);
                    mMap.m_iR = m_nRow;
        ...
        bt_TR.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                mMap.invalidate();
                if (myMaps.m_nTrun == 0)
                    MyToast.showToast(myGameView.this, getString(R.string.original_view), Toast.LENGTH_SHORT);
            }
        });
...
//                openMenu();
        ...
        bt_More.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                MyToast.showToast(myGameView.this, getString(R.string.you_can_leave_now), Toast.LENGTH_SHORT);
                StopMicro();  //停止“宏”功能运行
...
//            finish();
    ...
    private boolean myLock(int bRow, int bCol) {
        if (m_iR9 > -1) {
            if (mArray9 != null && isLock_Goal(m_cArray, bRow, bCol, m_nRow, m_nCol)) {
                lockDlg.setMessage(getString(R.string.this_move_creates_a_deadlock) + "\n" +getString(R.string.insufficient_space));
                return true;
            } else if (freezeDeadlock.isDeadlock(bRow, bCol)) {
                lockDlg.setMessage(getString(R.string.this_move_creates_a_deadlock) + "\n"+ getString(R.string.frozen_position));
                return true;
            } else if (closedDiagonalLock.isDeadlock(bRow * myMaps.curMap.Cols + bCol)) {
                lockDlg.setMessage(getString(R.string.this_move_creates_a_deadlock) + "\n"+ getString(R.string.closed_diagonal));
                return true;
            }
        }
        return false;
    ...
    private boolean myLock2(int bRow, int bCol) {
        if (m_iR10 > -1 && mark14 != null) {
            if (mArray9 != null && isLock_Count(bk_cArray, mark14, bRow, bCol, m_nRow2, m_nCol2)) {
                ...
                lockDlg.setMessage(getString(R.string.this_move_creates_a_deadlock) + "\n"+ getString(R.string.net_deadlock));
                return true;
            }
        }
        return false;
    ...
    private void mySetProgressBar() {
        ...
        if (bt_BK.isChecked()) {  //逆推
            ...
            if (len2 > 0) {
                ...
                MyToast.showToast(myGameView.this, getString(R.string.no_available_moves), Toast.LENGTH_SHORT);
            }
        } else {  //正推
            int len = m_lstMovUnDo.size();
            int len2 = m_lstMovUnDo.size() + m_lstMovReDo.size();
        ...
        switch (act) {
            ...
            case 10:  //宏调试（单步执行）时，结束调试，否则加载并执行宏
                if (myMaps.isMacroDebug) {
                    ...
                    isBack.setText(R.string.macro_actions_undone);
                    isBack.setChecked(true);
                    new Builder(myGameView.this, AlertDialog.THEME_HOLO_DARK).setTitle(R.string.turn_off_debugging)
                        .setView(isBack)
            ...
            case 11:  //进度条
                if (myMaps.isMacroDebug) {
                    MyToast.showToast(myGameView.this, getString(R.string.this_feature_is_not_supported_while_debugging_macros), Toast.LENGTH_SHORT);
                } else {
                    if (bt_BK.isChecked()) {  // 逆推
                        if (mMap.m_lGoto2) {
                            mMap.m_lGoto2 = false;
    ...
    private void saveAns(int m_Solution) {
        ...
        if (m_Solution == 0 && (m_lstMovUnDo.size() > myMaps.m_nMaxSteps || m_lstMovUnDo2.size() > myMaps.m_nMaxSteps) || m_Solution == 1 && m_lstMovUnDo.size() > myMaps.m_nMaxSteps) {  //答案或状态太长，保存到文档
            ...
            final int finalN = n;
            new Builder(this, AlertDialog.THEME_HOLO_DARK).setTitle(R.string.attention).setMessage(getString(R.string.solution_or_snapshot_too_long_to_save)+ "\n" + my_Name + "(" + n + ").txt").setCancelable(false)
            ...
            if (hh > 0) {
                if (m_Solution == 1) {
                    ...
                    MyToast.showToast(this, getString(R.string.the_solution_has_been_saved), Toast.LENGTH_LONG);
                    ...
                    MyToast.showToast(this, getString(R.string.state_has_been_saved), Toast.LENGTH_LONG);
                }
            } else if (hh == 0) {
                if (m_Solution == 1) {
                    myMaps.curMap.Solved |= (m_Solution == 1);
                    MyToast.showToast(this, getString(R.string.the_solution_is_a_duplicate_not_saved_again) + "\n"+ getString(R.string.move_2) + (m_iStep[1] + m_lstMovReDo.size()) + "，"+ getString(R.string.push_2) + (m_iStep[0] + m_iStep[2]), Toast.LENGTH_LONG);
                } else {
                    MyToast.showToast(this, getString(R.string.duplicates_found_rearranged), Toast.LENGTH_LONG);
                }
            } else {
                myMaps.curMap.Solved |= (m_Solution == 1);
                MyToast.showToast(this, getString(R.string.an_error_occurred_saving_failed), Toast.LENGTH_LONG);
            }
        }
    }
    ...
    private void saveAns2() {
        ...
        if (m_lstMovUnDo.size() + m_lstMovReDo.size() > myMaps.m_nMaxSteps) {  //答案太长，保存到文档
            ...
            final int finalN = n;
            new Builder(this, AlertDialog.THEME_HOLO_DARK).setTitle(getString(R.string.attention)).setMessage(getString(R.string.the_solution_is_too_long_to_save_to_a_file) + "\n" + my_Name + "(" + n + ").txt").setCancelable(false)
                    .setNegativeButton(getString(R.string.cancel), null)
                    .setPositiveButton(getString(R.string.okay), new OnClickListener() {
                        @Override
                        public void onClick(DialogInterface arg0, int arg1) {
            ...
            if (myMaps.curMap.Level_id > 0) {
                if (hh > 0) {
                    ...
                    builder.setTitle(getString(R.string.title_forward_and_reverse_match))
                            .setMessage(getString(R.string.the_solution_has_been_successfully_saved) + "\n"+ getString(R.string._you_can_use_the_arrow_keys_to_watch_the_walkthrough_demonstration_))
                            .setPositiveButton(getString(R.string.okay), null);
                    builder.setCancelable(false).show();
                } else if (hh == 0) {
                    Builder builder = new Builder(this, AlertDialog.THEME_HOLO_DARK);
                    builder.setTitle(getString(R.string.completed_forward_and_backward_path))
                            .setMessage(getString(R.string.the_solution_has_duplicates)+ "\n"+ getString(R.string.move_2) + (m_iStep[1] + m_lstMovReDo.size()) + "，"+ getString(R.string.push_2) + (m_iStep[0] + m_iStep[2]) + "，\n" + getString(R.string.this_time_no_save_was_made) +"\n" +getString(R.string._you_can_use_the_arrow_keys_to_watch_the_walkthrough_demonstration_))
                            .setPositiveButton(getString(R.string.okay), null);
                    builder.setCancelable(false).show();
                } else {
                    Builder builder = new Builder(this, AlertDialog.THEME_HOLO_DARK);
                    builder.setTitle(getString(R.string.forward_and_reverse_paths_match_or_puzzle_completed))
                            .setMessage(getString(R.string.db_write_error_please_use_the_clipboard_to_manually_save_the_solution_elsewhere)+ "\n"+ getString(R.string._you_can_use_the_arrow_keys_to_watch_the_walkthrough_demonstration_))
                            .setPositiveButton(getString(R.string.okay), null);
                    builder.setCancelable(false).show();
                }
            }
        ...
        try {
            ...
            if (len > 0) {
                ...
                if (myMaps.m_State.solution == 0) {  //答案，停在开始位置；状态，停在结束位置
                    ...
                    MyToast.showToast(this, getString(R.string.the_solution_has_been_successfully_loaded), Toast.LENGTH_SHORT);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem mt) {
        ...
        switch (mt.getItemId()) {
            ...
            case R.id.player_load:  //打开状态
                if (myMaps.isMacroDebug) {
                    final CheckBox isBack = new CheckBox(this);
                    isBack.setText(R.string.restore_the_puzzle_to_its_state_before_opening_this_macro);
                    isBack.setChecked(true);
                    new Builder(myGameView.this, AlertDialog.THEME_HOLO_DARK).setTitle(R.string.close_debugging)
                            .setView(isBack)
                            .setPositiveButton(getString(R.string.okay), new OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    if (isBack.isChecked()) {  //回到宏打开前的关卡状态
            ...
            case R.id.player_save:  //保存状态
                if (m_lstMovUnDo.size() > 0 || m_lstMovUnDo2.size() > 0) {
                    ...
                    MyToast.showToast(this, getString(R.string.there_is_nothing_to_save_), Toast.LENGTH_SHORT);
                }

                break;
            case R.id.player_ReStart:  //重新开始
                Builder builder0 = new Builder(myGameView.this);
                builder0.setMessage(getString(R.string.are_you_sure_to_restart)).setNegativeButton(getString(R.string.cancel), null)
                        .setPositiveButton(getString(R.string.okay), new OnClickListener() {
                            @Override
                            public void onClick(DialogInterface arg0, int arg1) {
...
//                break;
            case R.id.player_settings1:  //场景设置
                        ...
                        switch (which) {
                            ...
                            case 1:   //更换皮肤
                                ...
                                if (myMaps.mFile_List1.size() > 0) {
                                    ...
                                    builder.setTitle(getString(R.string.skin)).setSingleChoiceItems(myMaps.mFile_List1.toArray(new String[myMaps.mFile_List1.size()]), m_nItemSelect, new OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            case 2:   //设置背景图片
                                ...
                                if (myMaps.mFile_List2.size() > 0) {
                                    ...
                                    Builder builder = new Builder(myGameView.this, AlertDialog.THEME_HOLO_DARK);
                                    builder.setTitle(getString(R.string.background_image)).setSingleChoiceItems(myMaps.mFile_List2.toArray(new String[myMaps.mFile_List2.size()]), m_nItemSelect, new OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                ...
                break;
            case R.id.player_settings2:  //开关选项
                final String[] m_menu = {
                        getString(R.string.double_click_box_numbering),
                        getString(R.string.automatic_box_numbering),
                        getString(R.string.ruler),
                        getString(R.string.ruler_does_not_rotate_with_puzzle),
                        getString(R.string.distinguish_odd_even_tiles),
                        getString(R.string.deadlock_detection),
                        getString(R.string.reachability_hints),
                        getString(R.string.turning_animation),
                        getString(R.string.long_press_for_connected_network_hints),
                        getString(R.string.auto_load_latest_state),
                        getString(R.string.locate_double_pushes),
                        getString(R.string.auto_crossing),
                        getString(R.string.single_step_moves),
                        getString(R.string.progress_bar),
                        getString(R.string.auto_climb_stairs),
                        getString(R.string.system_navigation_keys),
                        getString(R.string.disable_fullscreen),
                        getString(R.string.push_only_during_demo),
                        getString(R.string.show_current_time_hints),
                ...
                builder.setTitle(getString(R.string.switch_options)).setMultiChoiceItems(m_menu, mChk, new DialogInterface.OnMultiChoiceClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                    }
                }).setNegativeButton(getString(R.string.reset), new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                ...
                }).setNeutralButton(getString(R.string.buttonText_default), new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            mChk[0] = false;    //双击箱子编号
                ...
                }).setPositiveButton(getString(R.string.buttonText_save), new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    public void setColorBK() {
        ...
        new Builder(this, AlertDialog.THEME_HOLO_DARK).setTitle(R.string.set_background_color_)
                .setView(view2)
                .setPositiveButton(getString(R.string.okay), new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
    ...
    protected void mySolution(int XYZ) {
        try {
            ...
            if ((m_iStep[1] > 0 || m_iStep[3] > 0) && mySQLite.m_SQL.count_S(myMaps.curMap.Level_id, m_iStep[1], m_iStep[0], m_iStep[3], m_iStep[2], m_nRow0, m_nCol0, myMaps.getCRC32(s1.toString()+s2.toString())) <= 0) {
                ...
                m_bMoved = false;
                if (hh > 0) {
                    MyToast.showToast(this, getString(R.string.the_status_has_been_saved), Toast.LENGTH_SHORT);
                }
            }
...
//                                bk_cArray[m_iPlayer2[0]][m_iPlayer2[1]] == '$' || bk_cArray[m_iPlayer2[0]][m_iPlayer2[1]] == '*')
                ...
                if (flg) {  //坐标有效，可以执行动作
                    ...
                    MyToast.showToast(this, getString(R.string.could_not_find_player), Toast.LENGTH_SHORT);
                }
            } else {  //正推， -- 执行动作(可能包含“宏”)
...
//                myDo_Block(0, myMaps.sAction.length - 1, false, false);     //这里延迟较长
    ...
    private void mLoad_Do_Macro() {
        if(bt_BK.isChecked()) {  //逆推
            MyToast.showToast(this, getString(R.string.reverse_push_does_not_support_macro_functionality), Toast.LENGTH_SHORT);
        } else {
            m_nItemSelect = -1;
            //关闭进度条、奇偶位明暗度调整条
            mMap.m_lGoto = false;                   // 正推“跳至”
            ...
            if (myMaps.mFile_List.size() > 0) {
                new Builder(this, AlertDialog.THEME_HOLO_DARK).setTitle(R.string.title_select_macro).setCancelable(false)
                ...
                MyToast.showToast(this, getString(R.string.no_macro_file_found_to_read), Toast.LENGTH_SHORT);
            }
        }
    }
    ...
    private class AsyncCountBoxsTask extends AsyncTask<Integer, Void, short[][]> {
        ...
        protected void onProgressUpdate(Void... values) {
            if (m_bNoSolution) {  //若为无解的关卡，则提醒
                ...
                dlg.setTitle(R.string.alertTitle_attention).setMessage(getString(R.string.this_is_an_unsolvable_puzzle_))
                        .setPositiveButton(getString(R.string.okay), null).setCancelable(false).create().show();
                m_bNoSolution = false;
            }
...
//                }
    ...
    private class RunMicroTask extends AsyncTask<Integer, Void, Void> {
        ...
        private final String[] msg = {"", getString(R.string.forward_clear), getString(R.string.forward_and_backward_clear), getString(R.string.reverse_clear)};
        private int type;
