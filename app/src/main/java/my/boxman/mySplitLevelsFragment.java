...
public class mySplitLevelsFragment extends DialogFragment {
    ...
    private final class SplitTask extends AsyncTask<Void, String, String> {
        ...
        void stopSplit() {
            if (mStatusUpdate != null) {
                ...
                if (statusUpdate != null) {
                    ...
                    statusUpdate.onSplitDone(getString(R.string.import_may_be_incomplete));
                }
            }
        }
        ...
        protected String doInBackground(Void... params) {
            ...
            if (myType < 0 || myFiles == null) return getString(R.string.no_parsable_content_found);

            publishProgress(getString(R.string.parsing___));
