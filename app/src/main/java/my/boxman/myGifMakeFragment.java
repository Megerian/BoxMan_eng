...
public class myGifMakeFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (mMessage == null) mMessage = getString(R.string.generating___);
        ...
        void stopGifMake() {
            ...
            if (mStatusUpdate != null) {
                ...
                if (statusUpdate != null) {
                    ...
                    statusUpdate.onGifMakeDone(getString(R.string.generation_finished));
                }
            }
        }
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                while (m_nStep < actArray.length) {
                    ...
                    publishProgress (getString(R.string.generating___) + (m_nStep) + "/" + actArray.length);
                }
            ...
            return getString(R.string.successfully_created)+ "\n" + "GIF/" + fn;
        }
