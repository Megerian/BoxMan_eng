...
public class myEditView extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dlg0.setTitle(R.string.alertTitle_attention).setMessage(R.string.there_are_unsaved_changes_are_you_sure_you_want_to_exit).setCancelable(false).setNegativeButton(R.string.no, null)
        ...
        bt_Cut.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (mMap.selNode.row < 0) {
                    MyToast.showToast(myEditView.this, getString(R.string.no_area_selected), Toast.LENGTH_LONG);
                    return;
                }
                ndAct = null;
        ...
        bt_Copy.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                //没有选区时
                if (mMap.selNode.row < 0) {
                    MyToast.showToast(myEditView.this, getString(R.string.no_block_selected), Toast.LENGTH_LONG);
                    return;
                }
                //将选择区域拼接成 XSB 字符串，送入系统“剪切板”
                StringBuilder str = new StringBuilder();
        ...
        bt_Paste.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (mMap.selNode.row < 0)
                    MyToast.showToast(myEditView.this, getString(R.string.please_specify_the_paste_location_first), Toast.LENGTH_SHORT);
                else{
                    //解析剪切板中的 XSB，通过 m_cSelArray[][]，粘贴的工作空间
                    String str = myMaps.loadClipper();
                    if (str.equals("")) {
                        MyToast.showToast(myEditView.this, getString(R.string.no_XSB_found_in_the_clipboard), Toast.LENGTH_SHORT);
                    } else {
                        ...
                        if (cutXSB(str)) {
                            ...
                            if (flg) {//若粘贴区域已有绘制，则进行覆盖提醒
                                ...
                                dlg.setTitle(R.string.alertTitle_attention).setMessage(R.string.existing_drawing_will_be_overwritten_are_you_sure).setNegativeButton(getString(R.string.cancel), null);
                                dlg.setPositiveButton(getString(R.string.okay), new DialogInterface.OnClickListener() {
                        ...
                        } else MyToast.showToast(myEditView.this, getString(R.string.unable_to_parse_XSB_from_the_clipboard), Toast.LENGTH_SHORT);
                    }
                }
            }});
        ...
        bt_Tru.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                String[] m_menu = {
                        getString(R.string.degrees_180),
                        getString(R.string.ninety_degrees_clockwise),
                        getString(R.string.ninety_degrees_counter_clockwise),
                        getString(R.string.horizontally_flipped),
                        getString(R.string.vertically_flipped)
                };

                if (mWhich < 0) mWhich = 1;  //默认"顺90度旋转",

                AlertDialog.Builder builder2 = new Builder(myEditView.this, AlertDialog.THEME_HOLO_DARK);
                builder2.setTitle(R.string.transform).setSingleChoiceItems(m_menu, mWhich, new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        mWhich = which;
                    }
        ...
        bt_Save.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (saveFile(myMaps.curMap.fileName)) {
                    MyToast.showToast(myEditView.this, getString(R.string.puzzle_saved), Toast.LENGTH_LONG);
                    bt_Save.setEnabled(false);
                } else
                    MyToast.showToast(myEditView.this, getString(R.string.error_save_failed), Toast.LENGTH_SHORT);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem mt) {
        switch (mt.getItemId()) {
            ...
            case R.id.edit_setup:  //设置
                String[] m_menu = {
                        getString(R.string.yasc_drawing_conventions),
            ...
            case R.id.edit_complete:  //提交
                if (bt_Save.isEnabled()) {  //试推前，若需保存
                    if (saveFile(myMaps.curMap.fileName)) {
                        ...
                        MyToast.showToast(myEditView.this, getString(R.string.error_puzzle_not_saved), Toast.LENGTH_LONG);
                    }
                }
                ...
                builder.setTitle(R.string.submit_to).setSingleChoiceItems(myList, mWhich, new OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        mWhich = which;
                    }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (mWhich == myList.length-1) {
                            try {
                                ...
                                MyToast.showToast(myEditView.this, getString(R.string.failed_to_create_a_new_puzzle_set) + myList[myList.length-1], Toast.LENGTH_SHORT);
                                return;
                            }
                        }
                        ...
                        if (mWhich >= 0 && Normalize2(m_cArray)) {
                            ...
                            if (lvl_id > 0) {
                                MyToast.showToast(myEditView.this, getString(R.string.submission_successful), Toast.LENGTH_SHORT);
...
//                                bt_Save.setEnabled(true);
                                ...
                                MyToast.showToast(myEditView.this, getString(R.string.error_submission_failed), Toast.LENGTH_SHORT);
                        }
                    }
            ...
            case R.id.edit_play:  //试推
                ...
                try {
                    ...
                    if (nd.L_CRC_Num != -1) {
                        ...
                        MyToast.showToast(this, getString(R.string.the_puzzle_is_not_valid), Toast.LENGTH_SHORT);
                    }
                } catch (Exception e) {
                    MyToast.showToast(this, getString(R.string.please_check_if_the_puzzle_is_valid), Toast.LENGTH_SHORT);
                }
                return true;
            ...
            case R.id.edit_clear:  //清空地图
                ...
                dlg0.setCancelable(false).setTitle(getString(R.string.positiveButton_confirm)).setMessage(R.string.the_map_will_be_cleared_are_you_sure).setNegativeButton(getString(R.string.cancel), null);
                dlg0.setPositiveButton(getString(R.string.okay), new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ndAct = null;
                ...
                dlg.setPositiveButton(getString(R.string.okay), new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (newLeft + newRight + mMap.m_nMapRight-mMap.m_nMapLeft+1 < 3) {
                            str.append(getString(R.string.puzzle_with_must_be_at_least_3)+ "\n");
                        }
                        if (newTop + newBottom + mMap.m_nMapBottom-mMap.m_nMapTop+1 < 3) {
                            str.append(getString(R.string.the_minimum_puzzle_height_is_3));
                        }
                        if (newLeft + newRight + mMap.m_nMapRight-mMap.m_nMapLeft+1 > myMaps.m_nMaxCol) {
                            str.append(getString(R.string.puzzle_width_is_too_high)).append(myMaps.m_nMaxCol).append("）\n");
                        }
                        if (newTop + newBottom + mMap.m_nMapBottom-mMap.m_nMapTop+1 > myMaps.m_nMaxRow) {
                            str.append(getString(R.string.puzzle_height_is_too_high)).append(myMaps.m_nMaxRow).append("）\n");
                        }
                        if (newLeft > mMap.m_nMapLeft-1) {
                            str.append(getString(R.string.not_enough_space_on_the_left)).append(mMap.m_nMapLeft-1).append("）\n");
                        }
                        if (newTop > mMap.m_nMapTop-1) {
                            str.append(getString(R.string.not_enough_space_on_the_top)).append(mMap.m_nMapTop-1).append("）\n");
                        }
                        if (newRight + mMap.m_nMapRight >= myMaps.m_nMaxCol*2-1) {
                            str.append(getString(R.string.not_enough_space_on_the_right)).append(myMaps.m_nMaxCol*2-1 - mMap.m_nMapRight).append("）\n");
                        }
                        if (newBottom + mMap.m_nMapBottom >= myMaps.m_nMaxRow*2-1) {
                            str.append(getString(R.string.not_enough_space_on_the_bottom)).append(myMaps.m_nMaxRow*2-1 - mMap.m_nMapBottom).append("）\n");
                        }

                        if (str.length() > 0) {
                            Builder dlg2 = new Builder(myEditView.this, AlertDialog.THEME_HOLO_DARK);
                            dlg2.setCancelable(true).setTitle(getString(R.string.error)).setPositiveButton(getString(R.string.okay), null).setMessage(str);
            ...
            case R.id.edit_inf:  //关卡作者、标题、说明等资料编辑
                if (myMaps.curMap.Map == null) {
                    MyToast.showToast(myEditView.this, getString(R.string.please_save_the_puzzle_first), Toast.LENGTH_SHORT);
                } else {
                    old_Map = myMaps.curMap;
    ...
    public void DoAct(int act) {
        ...
        if (act == 0) {
            ...
            dlg.setTitle(getString(R.string.please_select)).setSingleChoiceItems(new String[]{getString(R.string.Fill), getString(R.string.stroke)}, 0, new OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    m_nItemSelect = which;
                }
    ...
    private void myImport() {
        String str = myMaps.loadClipper();
        if (str.equals("")) {
            MyToast.showToast(this, getString(R.string.there_is_no_data_to_import), Toast.LENGTH_SHORT);
        } else {
            final EditText et = new EditText(this);
            et.setTypeface(Typeface.MONOSPACE);
            et.setText(str);
    ...
    private void myRot90(final boolean is90) {
        ...
        if (flg) {//旋转会覆盖部分已绘制的区域，则进行覆盖提醒
            ...
            dlg.setTitle(R.string.alertTitle_attention).setMessage(R.string.this_will_overwrite_part_of_your_existing_drawing_do_you_want_to_continue).setCancelable(false).setNegativeButton(getString(R.string.cancel), null);
            dlg.setPositiveButton(getString(R.string.okay), new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ndAct = null;
                    ndAct = new ActNode(m_cArray, mMap.m_nMapLeft, mMap.m_nMapRight, mMap.m_nMapTop, mMap.m_nMapBottom, -1, -1, null, null, mMap.selNode, mMap.selNode2);
    ...
    private void myBlockSave(char[][] m_Level) {
        //没有选区时
        if (mMap.selNode.row < 0) {
            MyToast.showToast(this, getString(R.string.please_select_a_block), Toast.LENGTH_LONG);
            return;
        }
        ...
        if (r2-r1 < 1 || c2-c1 < 1) {
            MyToast.showToast(this, getString(R.string.the_block_is_too_small), Toast.LENGTH_LONG);
            return;
        }
        ...
        try{
            ...
            AlertDialog.Builder dlg = new Builder(this, AlertDialog.THEME_HOLO_DARK);
            dlg.setTitle(getString(R.string.success)).setMessage(getString(R.string.title)+ "\n"+fn).setCancelable(false)
                    .setPositiveButton(getString(R.string.okay), null).create().show();
        } catch(Exception e) {
            AlertDialog.Builder dlg = new Builder(this, AlertDialog.THEME_HOLO_DARK);
            dlg.setTitle(getString(R.string.error)).setMessage(getString(R.string.write_error_saving_failed)).setCancelable(false)
                    .setPositiveButton(getString(R.string.okay), null).create().show();
        }
    }
    ...
    public boolean Normalize2(char[][] mLevel) {
        ...
        if (nRen != 1) {
            AlertDialog.Builder dlg = new Builder(this, AlertDialog.THEME_HOLO_DARK);
            dlg.setTitle(getString(R.string.error)).setMessage(R.string.wrong_number_of_players).setCancelable(false)
                    .setPositiveButton(getString(R.string.okay), null).create().show();
        ...
        if (nBox != nDst || nBox < 1 || nDst < 1) {  //可达区域内的箱子与目标点数不正确
            AlertDialog.Builder dlg = new Builder(this, AlertDialog.THEME_HOLO_DARK);
            dlg.setTitle(getString(R.string.title_warning)).setMessage(getString(R.string.incorrect_number_of_boxes_on_goals)+ "\n"+ "" +
                            getString(R.string.number_of_boxes)+nBox+"，"+ getString(R.string.number_of_targets)+nDst+"").setCancelable(false)
                    .setPositiveButton(getString(R.string.okay), null).create().show();
    ...
    private void Normalize(char[][] mLevel) {
        ...
        if (nRen != 1) {
            AlertDialog.Builder dlg = new Builder(this, AlertDialog.THEME_HOLO_DARK);
            dlg.setTitle(getString(R.string.error)).setMessage(getString(R.string.wrong_number_of_players)).setCancelable(false)
                    .setPositiveButton(getString(R.string.okay), null).create().show();
        ...
        if (nBox != nDst || nBox < 1 || nDst < 1) {  //可达区域内的箱子与目标点数不正确
            MyToast.showToast(this, getString(R.string.incorrect_number_of_boxes_on_goals)+ "\n"+
                    getString(R.string.number_of_boxes)+nBox+"，"+ getString(R.string.number_of_targets)+nDst, Toast.LENGTH_LONG);
        }
